...
{
    lang_dict_["get teamfile download link"] = "获取共享链接";
    lang_dict_["get teamfile internal link"] = "获取内部链接";
...
{
    lang_dict_["get teamfile download link"] = "Freigabelink erstellen";
    lang_dict_["get teamfile internal link"] = "Internen Link erstellen";
